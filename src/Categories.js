  ...
  return (
    <div className="justify-center mx-auto px-6 pb-4 sm:px-12  sm:flex-row items-center ">
      ...
      <div className="flex flex-wrap justify-center">
        <Link to="/books">
          <div class="flex justify-center bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-40 transition duration-500 ease-in-out bg-gray-200 hover:bg-gray-300 transform hover:-translate-y-1 hover:scale-110">
            <div class="mb-3">
              <img class="w-auto mx-auto h-12 " src={book} alt="books" />
            </div>
            <h2 class="ml-4 pt-4 text-md font-medium text-gray-700">Books</h2>
          </div>
        </Link>
        ...
        <div class="flex justify-center bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-40 transition duration-500 ease-in-out bg-gray-200 hover:bg-gray-300 transform hover:-translate-y-1 hover:scale-110">
          <div class="mb-3">
            <img class="w-auto mx-auto h-12  " src={movie} alt="movies" />
          </div>
          <h2 class="ml-4 pt-4 text-md font-medium text-gray-700">
            Movies
          </h2>
        </div>
        </Link>
        ...
        <div class="flex justify-center bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-40 transition duration-500 ease-in-out bg-gray-200 hover:bg-gray-300 transform hover:-translate-y-1 hover:scale-110 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-12  " src={podcast} alt="podcast" />
          </div>
          <h2 class="ml-4 pt-4 text-md font-medium text-gray-700">Podcasts</h2>
        </div>
          </Link>
