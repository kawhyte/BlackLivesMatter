    ...
    <div className="justify-center mx-auto px-6 pb-6 sm:px-12  sm:flex-row items-center bg-red-100 ">
      ...
      <div className="flex flex-wrap justify-center ">
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-20 " src={book} alt="" />
          </div>
        ...
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          ...
          <h2 class="text-xl font-medium text-gray-700">Movies</h2>
        </div>
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-20  " src={movie} alt="" />
        ...
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-20  " src={podcast} alt="" />
          </div>
          <h2 class="text-xl font-medium text-gray-700">Podcasts</h2>
        </div>
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-20  " src={article} alt="" />
          </div>
          <h2 class="text-xl font-medium text-gray-700">Articles</h2>
        </div>
        <div class="bg-gray-200 px-2 py-2 m-2 rounded-lg text-center w-56 ">
          <div class="mb-3">
            <img class="w-auto mx-auto h-20  " src={business} alt="" />
          </div>
