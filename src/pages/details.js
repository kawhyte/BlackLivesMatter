  ...
  return (
    ...
    <section className="flex  flex-wrap justify-center container mx-auto px-6 sm:px-12 flex flex-col-reverse sm:flex-row items-center">
      <div className="px-5 py-24 justify-center  ">
        <div className="container  px-6 px-12  justify-center sm:px-12 flex flex-col sm:flex-row  bg-red-400">
         
         <div className="sm:w-3/5 bg-green-400 flex items-center justify-center "> 
          <img
          ...
          <div className="w-full sm:w-3/5  ml-2">
            ...
            <span className="text-sm text-left" >Released by {item.published} on {item.date}</span>
