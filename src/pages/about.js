...
{/* <h1 className="mt-24 text-2xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-3xl sm:leading-none md:text-4xl">About</h1> */}
    ...
    <main class="mt-8">
      ...
      <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style={{height: "24em"}}>
        ...
        <img src="https://images.unsplash.com/photo-1590989995665-1815e7b2c42b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1526&q=80" class="absolute left-0 top-0 w-full h-full z-0 object-cover" />
      ...
      <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
        ...
        <div class="border-l-4 border-gray-500 pl-4 mb-6 italic rounded text-left">
...
<div className="container mx-auto mt-8 text-gray-900 text-left">
