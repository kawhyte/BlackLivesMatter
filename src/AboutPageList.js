...
<section
      className={
        "mb-1 h-40 md:h-56 items-start justify-start flex flex-col  lg:mt-10 sm:mt-2 bg-black  px-8 md:px-20   "
      }
      // style={{
...
<div className="container mx-auto"> 
      <h1 className=" text-left mt-8 sm:mt-16 text-3xl tracking-tight uppercase sm:leading-1 font-extrabold  text-white sm:text-3xl sm:leading-none md:text-5xl">
