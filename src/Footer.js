        ...
        <div className="container py-6">
          <div className="flex flex-col items-start  mt-6 md:flex-row">
            <div className="flex flex-col items-start  justify-start mr-8 mb-2">
              <p
                href="/"
                className="text-left text-sm text-gray-500 font-bold pb-4 uppercase"
              >
                {data.site.siteMetadata.title}
              </p>
              <Link
                to="/know-their-names"
                className="text-left text-gray-400 text-sm py-1"
              >
                Know their names
              </Link>
              <Link
            ...
            <div className="flex flex-col  md:ml-10">
              <p
                href="/"
                className="text-sm font-bold text-gray-500 pb-4 uppercase text-left mt-4 sm:mt-0"
              >
                Learn More
              </p>
              <a
                ...
                className="text-sm text-gray-400 text-left py-1"
              >
